...
class Aislamiento_tierraController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_GET['id'])) {
            ...
            if (isset($motor)) {
                if (!isset($motor->plan_mant_aislamiento)) {
                    echo 'No se puede crear nuevo registro porque el motor no tiene plan de mantenimiento de aislamiento.
                        <br>
                        <a href=/index.php/motores/update?id=' . $motor->id . '">Haga click para ingresar el plan de mantenimiento del motor ' . $motor->Motor . '</a>
                        <br> Y luego intente de nuevo. ';
                    $continuar = 0;
                }else 
                if ($motor->plan_mant_aislamiento == 0) {
                    echo 'No se puede crear nuevo registro porque el motor no tiene plan de mantenimiento de aislamiento.
