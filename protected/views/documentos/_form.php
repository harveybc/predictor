...
<div styler="padding-left:50px;">
    <div>
        <div>
            <label for="Secuencias">Este documento tiene la siguiente Secuencia</label><?php
...
?>
            ...
            <div>
                <label for="OrdenSecuencias">Este documento tiene el siguiente orden de secuencias</label><?php
$this->widget('application.components.Relation', array(
    'model' => $model,
