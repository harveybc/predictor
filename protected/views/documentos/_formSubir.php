...
$this->widget('zii.widgets.jui.CJuiAccordion', array(
    'panels' => array(
        'Datos de Básicos' => $this->renderPartial('_accordionSubir', array('form' => $form, 'modelMeta' => $modelMeta, 'modelArchivo' => $modelArchivo, 'model' => $model, 'panel' => "0"), true),
        'Opciones Avanzadas' => $this->renderPartial('_accordionSubir', array('form' => $form, 'modelMeta' => $modelMeta, 'model' => $model, 'panel' => "1"), true),
        'Datos de Creación y Revisión' => $this->renderPartial('_accordionSubir', array('form' => $form, 'modelMeta' => $modelMeta, 'model' => $model, 'panel' => "2"), true),
    ),
