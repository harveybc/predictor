...
?>
        ...
        <div>
            <div>
                <label for="Documentos">Documentos</label><?php
$this->widget('application.components.Relation', array(
    'model' => $model,
    'relation' => 'documento0',
    'fields' => 'descripcion',
...
?>
            ...
            <div>
                <label for="Usuarios">Autores</label><?php
$this->widget('application.components.Relation', array(
    'model' => $model,
    'relation' => 'usuario0',
    'fields' => 'Username',
...
?>
        ...
        <div>
            <div>
                <label for="Secuencias">Tiene las siguientes secuencias</label><?php
$this->widget('application.components.Relation', array(
    'model' => $model,
    'relation' => 'secuencia0',
    'fields' => 'descripcion',
...
?>
            ...
            <div>
                <label for="OrdenSecuencias">Orden de secuencias</label><?php
$this->widget('application.components.Relation', array(
    'model' => $model,
