...
?>
    ...
    {
        $('#Termomotores_TAG').html(data.value1);
...
<?php $this->setPageTitle (' Crear informe de termografia de motores '); ?>
<div class="form">
...
// dibuja el dropDownList de Proceso, seleccionando los valores diferentes presentes en la tabla Estructura col. Proceso
            ...
            <div>
                ...
                // dibuja el dropDownList de Proceso, seleccionando los valores diferentes presentes en la tabla Estructura col. Proceso
                echo CHtml::dropDownList(
                        'Termomotores[TAG]', $valor, CHtml::listData(Motores::model()->findAllbySql(
                                        isset($modeloId) ?
