...
?>
    ...
    {
        $('#linkNuevo').html('<a href="/index.php/termomotores/create?id='+encodeURIComponent(document.getElementById("motor").value)+'">Nueva medición</a>');
<?php
echo CHtml::ajax(array(
    'type' => 'GET', //request type
    'data' => array('TAG' => 'js:document.getElementById("motor").value'),
    'update' => '#gridFechas',
    'url' => CController::createUrl('/termomotores/dynamicFechas'), //url to call.
        //'update' => '#Visitas_idDoctor', //selector to update
...
$this->menu = array(
    ...
    array('label' => Yii::t('app', 'Nueva Medición'),
        'url' => array('create' . $sufix), 'itemOptions' => array('id' => 'linkNuevo')),
);
...
Yii::app()->clientScript->registerScript('search', "
			...
			$('.search-form form').submit(function(){
				$.fn.yiiGridView.update('termomotores-grid', {
data: $(this).serialize()
});
				return false;
				});
...
<?php $this->setPageTitle(' Gestionar&nbsp; Termografia de Motores'); ?>
    ...
    <tr>
        <td  style="width:65%;padding: 0px;vertical-align:top;">
            <div style="width:100%;vertical-align:top; text-align:center;" >
                <img src="/images/TermoCriterios.png" style="width:100%; max-width:400px;vertical-align:top;"/>
            </div><!-- header -->
        </td>
        <td>
            <form>
                <table style="vertical-align:top;margin-left:0px;margin-bottom:5px !important; ">
                    <tr>
                        <td style="width:50%;">
                            <b>Area:</b>
                            <?php
...
// dibuja el dropDownList de Proceso, seleccionando los valores diferentes presentes en la tabla Estructura col. Proceso
                    ...
                    <tr>
                        <td style="width:50%;">
                            ...
                            echo CHtml::dropDownList(
                                ...
                                'style' => 'width:100%;',
                                'class' => 'filtro',
                                'empty' => 'Por favor seleccione el proceso',
                                    )
                            );
                            ?>
                        </td>
                ...
                <table style="margin-left:0px;margin-bottom:5px !important; ">
                    <tr>
                        <td>
                            <b>Equipo:<br/></b>
                            <?php
                            ...
                            echo CHtml::dropDownList(
                                ...
                                'style' => 'width:100%;',
                                'class' => 'filtro',
                                'empty' => 'Por favor seleccione el equipo',
                                    )
                            );
                            ?>
                        </td>
                    ...
                    <tr>
                        <td>
                            ...
                            echo CHtml::dropDownList(
                                ...
                                'style' => 'width:100%;',
                                'class' => 'filtro',
                                'empty' => 'Por favor seleccione un motor',
