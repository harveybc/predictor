...
$this->breadcrumbs=array(
	'Aislamiento Acometidas'=>array(Yii::t('app', 'index')),
	Yii::t('app', 'Gestionar'),
);
...
$this->menu=array(
		...
		Yii::app()->clientScript->registerScript('search', "
			...
			$('.search-form form').submit(function(){
				$.fn.yiiGridView.update('aislamiento-acometida-grid', {
data: $(this).serialize()
});
				return false;
				});
...
<?php $this->setPageTitle (' Gestionar&nbsp;Medición Aislamiento Acometida'); ?>
