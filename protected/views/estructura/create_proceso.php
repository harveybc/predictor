...
<?php $this->setPageTitle (' Nuevo Proceso '); ?>
<div class="form">
...
// dibuja el dropDownList de Area, dependiendo del proceso selecccionado
                    echo CHtml::textField('Estructura[Area]',$valor, array(
        ...
        El nuevo proceso debe contener al menos un equipo, por favor ingrese el código SAP y el nombre del equipo a continuación.
        </div> 
