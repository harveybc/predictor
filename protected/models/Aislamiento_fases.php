...
/**
 * This is the model class for table "aislamiento_fases".
 *
 * The followings are the available columns in table 'aislamiento_fases':
 ...
 * @property integer $OT
 */
class Aislamiento_fases extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return Aislamiento_fases the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('A025,A2,B025,B2,C025,C2,A050,A050, A1, B050, B1, C050, C1', 'numerical'),
			...
			array('Toma, TAG, Fecha, A050, A1, B050, B1, C050, C1, OT', 'safe', 'on'=>'search'),
