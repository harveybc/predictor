...
class Plugin:
    ...
    def build_model(self, input_shape):
        ...
        for size in layers[:-1]:
            if size > 1:
                x = LSTM(size, activation='relu', recurrent_activation='sigmoid', kernel_initializer=GlorotUniform(),kernel_regularizer=l2(self.params.get('l2_reg', 1e-4)), return_sequences=True)(x)
