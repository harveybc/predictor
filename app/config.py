...
DEFAULT_VALUES = {
    "use_normalization_json": "examples\\data\\phase_3\\debug_out.json",
    ...
    "y_train_file": "examples\\data\\phase_3\\phase_3_normalized_d2.csv",
    ...
    "y_validation_file": "examples\\data\\phase_3\\phase_3_normalized_d3.csv",
