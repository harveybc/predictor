...
#bilstm
from tensorflow.keras.layers import Bidirectional, LSTM, MultiHeadAttention
import gc
import os
...
class Plugin:
    ...
    def build_model(self, input_shape, x_train, config):
        ...
        for i, horizon in enumerate(predicted_horizons):
            ...
            lstm_output = LSTM(lstm_units, return_sequences=True), name=f"bidir_lstm{branch_suffix}"(reshaped_for_lstm)
